...
function getinfo() {
    ...
    var horo = document.getElementById("result").innerHTML;
    ...
    for (x=0;check=="";x++ ) {
        ...
        if (horo==array[x].name) {
            ...
            document.getElementById("desc").innerHTML = "Main character:" + array[x].desc;
            document.getElementById("pic").setAttribute("src", array[x].img);
            check = document.getElementById("desc").innerHTML;}
